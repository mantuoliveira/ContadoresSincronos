...
- Todos os estados aparecem no diagrama. Clique num nó para levar o contador a esse estado e iniciar ou retomar a sequência a partir dele. A lista textual abaixo também contém todas as transições.
